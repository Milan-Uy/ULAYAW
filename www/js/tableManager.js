...
2)
    ...
    <script type="text/javascript" src="PATH_TO_YOUR_FILE/js/tableManager.js"></script>
...
(function ($) {
  ...
  $.fn.tablemanager = function (options = null) {
    ...
    showrows =
      options !== null && options.showrows != "" && typeof options.showrows !== undefined && options.showrows !== undefined
        ? options.showrows
        : showrows;
    ...
    if (options !== null) {
      ...
      if (options.vocabulary != "" && typeof options.vocabulary !== undefined && options.vocabulary !== undefined) {
        ...
        voc_filter_by =
          options.vocabulary.voc_filter_by != "" && options.vocabulary.voc_filter_by !== undefined ? options.vocabulary.voc_filter_by : voc_filter_by;
        ...
        voc_show_rows =
          options.vocabulary.voc_show_rows != "" && options.vocabulary.voc_show_rows !== undefined ? options.vocabulary.voc_show_rows : voc_show_rows;
      }
    ...
    function multipleSortCol(array, data) {
      ...
      array.sort(function (a, b) {
        for (i = 0; i < cols.length; i++) {
          ...
          let secondCol = new DOMParser().parseFromString(b[cols[i]], "text/html").documentElement.textContent;
